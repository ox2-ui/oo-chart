module.exports = {
  ...
  rules: {
    ...
    'id-blacklist': 'off', // XXX Meteor events (e) paramt ['error', 'e']
    'jsx-quotes': ['error', 'prefer-double'],
    'keyword-spacing': 'error',
    'key-spacing': 'error',
    'max-len': 'off', // XXX Meteor Collection calls default: ['error', 120, 4]
    'new-cap': ['off', {capIsNew: true, newIsCap: true}], // Wishlist, one day
    'no-unused-expressions': 'error',
    'no-unused-vars': 'off', // XXX Meteor stuff inestigate
    'no-shadow': 'off', // Wishlist, one day
    'no-spaced-func': 'error',
    'no-multiple-empty-lines': 'error',
    'no-multi-spaces': 'error',
    'no-undef': 'off', // XXX enable when moving to imports
    ...
    'no-underscore-dangle': 'off', // XXX Meteor _id
